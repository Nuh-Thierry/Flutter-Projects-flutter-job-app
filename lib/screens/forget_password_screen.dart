...
class _forgetPasswordState extends State<forgetPassword> with TickerProviderStateMixin {
  ...
  final TextEditingController _frogetPassTextController = TextEditingController(text: '');
    ...
    try
        {
          await _auth.sendPasswordResetEmail(
              email: _frogetPassTextController.text,
          );
          ...
          Padding(
            ...
            child: ListView(
              children: [
                ...
                TextField(
                  controller: _frogetPassTextController,
