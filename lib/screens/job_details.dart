...
import 'package:job/services/global_variables.dart';
import 'package:job/widgets/comments_widget.dart';
  ...
  void getJobData() async
  {
    ...
    else
    {
      setState(() {
        ...
        recruitment = jobDataBase.get('recruitments');
        emailCompany = jobDataBase.get('email');
        companyLocation = jobDataBase.get('location');
        applicants = jobDataBase.get('applicants');
        postedDateTimeStamp = jobDataBase.get('createdAt');
        deadLineDateTimeStamp = jobDataBase.get('deadLineDateTimeStamp');
        deadLineDate = jobDataBase.get('deadLine Date');
                                          ...
                                          if(_uid == widget.uploadedBy)
                                          {
                                            try
                                            {
                                              FirebaseFirestore.instance.collection('jobs')
                                                  .doc(widget.jobId)
                                                  .update({'recruitments': true});
                                            }catch (error)
                                            {
                                              GlobalMethods.showErrorDialog(
                                                  error: 'Action cannot be performed', ctx: context
                                              );
                                            }
                                          }
                                          else
                                          ...
                                          Padding(
                                            ...
                                            child: MaterialButton(
                                              onPressed: () async
                                              {
                                                ...
                                                {
                                                  GlobalMethods.showErrorDialog(
                                                      error: 'Comment length cannot be less then 7 characters',
                                                      ctx: context,
                                                  );
                                                }
                                                else
